...
const envSchema = z
  .object({
    ...
    TRACKING_ADAPTER: z.enum(["mock", "soap"]).default("mock"),
    SOAP_TRACKING_WSDL: z.string().url().optional(),
    SOAP_TRACKING_ENDPOINT: z.string().url().optional(),
    SOAP_TRACKING_METHOD: z.string().min(1).default("TrackRoute"),
  })
